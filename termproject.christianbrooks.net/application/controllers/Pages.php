...
class Pages extends CI_Controller {
	...
	public function form()
	{
		...
		//$this->form_validation->set_rules("radio", "stream", "required");
	...
	public function secure()
	{
		...
		$this->data['content'] = "pages/secure";
		$this->load->view('template/baseTemplate', $this->data);
	}
	...
	public function facebook()
	{
		...
		$this->data['content'] = "pages/facebook";
		$this->load->view('template/baseTemplate', $this->data);
	}
	...
	public function signup()
	{
		...
		$this->data['content'] = "pages/signup";
		$this->load->view('template/baseTemplate', $this->data);
	}
	public function created()
	{
		...
		$this->data['content'] = "pages/created";
		$this->load->view('template/baseTemplate', $this->data);
	}
	public function file_upload()
	{
		$config['upload_path']='G:\\PleskVhosts\\christianbrooks.net\\termproject.christianbrooks.net\\uploads';
	...
	public function imageResize()
	{
		...
		$config['source_image'] = 'G:\\PleskVhosts\\christianbrooks.net\\termproject.christianbrooks.net\\uploads\\'.$file[0]->IMAGE;
	...
	public function showImage()
	{
		...
		$image = 'G:\\PleskVhosts\\christianbrooks.net\\termproject.christianbrooks.net\\uploads';
		if(is_numeric($this->uri->segment(3)))
		{
